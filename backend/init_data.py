...
def generate_turbine_data(node_id, output_dir, n_samples=5000):
    """
...
def main():
    """Initialize the data for all edge nodes"""
    ...
    for node_id in range(1, node_count + 1):
        node_data_dir = os.path.join("backend", "edge_node", "data", f"node{node_id}")
        generate_turbine_data(node_id, node_data_dir)
